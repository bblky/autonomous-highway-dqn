...
$$R_t = (w_{speed} \cdot R_{speed}) - (w_{risk} \cdot R_{risk}) + R_{center} + P_{\text{lane\_change}} + P_{crash}$$
...
4.  **Penalties:**
    ...
    * $P_{\text{lane\_change}} = -0.05$: A minor fee to prevent unnecessary zigzagging.
